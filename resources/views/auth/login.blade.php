            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="login">
                        ...
                        <div class="form-group row">
                            <label for="parole" class="col-md-4 col-form-label text-md-right">Parole</label>

                            <div class="col-md-6">
                                <input id="parole" type="password" class="form-control @error('parole') is-invalid @enderror" name="parole" required >
